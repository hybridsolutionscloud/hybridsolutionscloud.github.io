# hybridsolutionscloud.github.io — Agent instructions
...
```
bootstrap(repo="hybridsolutionscloud.github.io", client="<your client: claude-code | codex | gemini | cursor | vscode>")
```
